...
export function TaskForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          {isEditing && (
            <p className="text-xs text-muted-foreground">
              Project assignment is generated by the workflow and cannot be changed here.
            </p>
          )}
          {errors.project_id && (
      ...
      {/* Hours */}
      <div className="space-y-4">
        <h3 className="text-sm font-medium">Planning Effort</h3>
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
        ...
        {isEditing && (
          <p className="text-xs text-muted-foreground">
            Dependencies, execution order, internal IDs, and audit fields are protected workflow data.
          </p>
        )}
      </div>
